export default {
	...
	view: {
		...
		download: "Download",
		details: {
			toggle: "Show message details",
			date: "Date",
			mailedBy: "Mailed by",
			signedBy: "Signed by",
			security: "Security",
			spfNone: "Unverified",
			spfFail: "Unverified (SPF failed)",
			dkimNone: "Unsigned",
			dkimFail: "Invalid signature (DKIM failed)",
			encrypted: "Standard encryption (TLS)",
			encryptedWith: "Standard encryption ({{detail}})",
			plain: "Not encrypted: the connection did not use TLS",
			internal: "Internal delivery within the platform",
		},
	},
	actions: {
		star: "Star",
