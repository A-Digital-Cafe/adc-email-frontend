export default {
	...
	view: {
		...
		download: "Descargar",
		details: {
			toggle: "Ver detalles del mensaje",
			date: "Fecha",
			mailedBy: "Enviado por",
			signedBy: "Firmado por",
			security: "Seguridad",
			spfNone: "Sin verificar",
			spfFail: "No verificado (SPF falló)",
			dkimNone: "Sin firmar",
			dkimFail: "Firma inválida (DKIM falló)",
			encrypted: "Cifrado estándar (TLS)",
			encryptedWith: "Cifrado estándar ({{detail}})",
			plain: "Sin cifrar: la conexión no usó TLS",
			internal: "Entrega interna en la plataforma",
		},
	},
	actions: {
		star: "Destacar",
